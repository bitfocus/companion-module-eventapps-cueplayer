...
export function buildActions(self: CuePlayerInstance): CompanionActionDefinitions {
  ...
  return {
    ...
    page: {
      ...
      options: [
        {
          type: 'dropdown', id: 'to', label: 'Page', default: 'player',
          choices: [{ id: 'player', label: 'Player' }, { id: 'jingles', label: 'Jingles' }],
        },
      ],
